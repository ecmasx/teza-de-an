...
export default function Hero() {
  return (
    <section
      className="relative w-full h-[calc(100vh-150px)] flex flex-col justify-end md:justify-center md:items-start rounded-[0.75rem] overflow-hidden mb-10"
      style={{
    ...
    >
      <div className="relative z-10 w-full md:max-w-xl text-left text-black drop-shadow-xl p-6 md:p-0 md:mb-0 mb-6 md:ml-0 md:pl-24">
        <h1 className="text-3xl md:text-4xl font-medium mb-4 leading-tight">
          Furniture that fits your life.
        </h1>
        <p className="text-base max-w-md md:text-lg mb-6 font-medium text-black/80">
